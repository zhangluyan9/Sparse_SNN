...
load_name = "baseline_T6_VGG13_step100dot05_step2.pt"
...
save_name = "baseline_T6_VGG13_step100dot05_step2.pt"
weight_d_f = 0
sc_f = 1e-6
...
def main():
    ...
    #model_ = torch.hub.load("chenyaofo/pytorch-cifar-models", "cifar100_vgg13_bn", pretrained=True)
    #torch.save(model_.state_dict(),'vgg13_chaoyao_cifar100.pt')
