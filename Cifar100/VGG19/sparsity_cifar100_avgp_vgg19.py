...
load_name = "baseline_T6_VGG19_cifar100_step1_step2_1_2_.pt"
#load_name = 'baseline_T6_VGG19_cifar100.pt'
...
save_name = "baseline_T6_VGG19_cifar100_step1_step2_1_2.pt"
save_name_ = "baseline_T6_VGG19_cifar100_step1_step2_1_2_.pt"
weight_d_f = 0.05
sc_f = 1e-6
...
def main():
    ...
    model = VGG_16('VGG19', clamp_max=1,bias =True).to(device)
    #model_ = torch.hub.load("chenyaofo/pytorch-cifar-models", "cifar100_vgg19_bn", pretrained=True)
