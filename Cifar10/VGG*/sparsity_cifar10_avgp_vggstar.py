...
load_name = "baselineVGGstar.pt"
#load_name = "../../zhanglu_naga/zhanglu/Low-latency-SNNs/pretrain_weight/cifar10/cifar10_t_8_10.pt"
#load_name = "baseline_T6_VGG13_step10dot05_step2lr1e-7.pt"
...
save_name = "baselineVGGstar_step1_3.pt"
save_name_1 = "baselineVGGstar_step1_3_.pt"
save_1 = 'merge_ours_baseline.pt'
weight_d_f = 0.05
sc_f = 1e-7
...
def main():
    ...
    #model_ = torch.hub.load("chenyaofo/pytorch-cifar-models", "cifar10_vgg13_bn", pretrained=True)
    #torch.save(model_.state_dict(),'vgg13_chaoyao.pt')
    ...
    torch.save(model.state_dict(),save_1)
    #for param_tensor in model.state_dict():
    #    print(param_tensor, "\t", model.state_dict()[param_tensor].size())
    test(model, device, test_loader, args.noise,args.use_function,args.clamp_max)
