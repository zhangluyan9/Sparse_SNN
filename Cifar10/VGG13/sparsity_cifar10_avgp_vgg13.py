...
#load_name = "baseline_T6/baseline_T6_VGG13.pt"
...
save_name = "baseline_T6_VGG13_step10dot05_step2lr1e-7.pt"
save_1 = 'merge_ours.pt'
weight_d_f = 0
sc_f = 1e-7
...
def main():
    ...
    model = VGG_16('VGG13', clamp_max=1,bias =True).to(device)
