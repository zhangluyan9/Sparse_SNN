...
#load_name = "T6_new_ex/baseline_T6_0_05_1.pt"
load_name = "baseline_T6/baseline_T6.pt"
#load_name = 'baseline_T6_0_05_2.pt'
#load_name = "../../zhanglu_naga/zhanglu/robustness_qnn/VGG16/VGG16_chenyaofo.pt"
...
save_name = "T6_new_ex/baseline_T6_abstudy.pt"
save_name_1 = "abs/w1.pt"
save_name_2 = "abs/w2.pt"
save_name_3 = "abs/w3.pt"
save_name_4 = "abs/w4.pt"
save_name_5 = "abs/w5.pt"
save_name_6 = "abs/w6.pt"
save_name_7 = "abs/w7.pt"
save_name_8 = "abs/w8.pt"
save_name_9 = "abs/w9.pt"
save_name_10 = "abs/w10.pt"

#save_name_ = 'SNN_weight/baseline_T6_lr1k0dot05_sc1e-8_5e-3.pt'
weight_d_f = 0.05
sc_f = 1e-6
...
def main():
    ...
    test_loader = torch.utils.data.DataLoader(dataset2,batch_size=2048) 
    ...
    scheduler = MultiStepLR(optimizer, milestones=[120, 200, 300], gamma=0.2)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        #print(epoch)
        if ACC_>ACC_1 and epoch < 10:
            ACC_1 = ACC_
            torch.save(model.state_dict(),save_name_1)
        
        if ACC_>ACC_2  and epoch>=10 and epoch < 20:
            ACC_2 = ACC_
            torch.save(model.state_dict(),save_name_2)

        if ACC_>ACC_3  and epoch>=20 and epoch < 30:
            ACC_3 = ACC_
            torch.save(model.state_dict(),save_name_3)
        
        if ACC_>ACC_4  and epoch>=30 and epoch < 40:
            ACC_4 = ACC_
            torch.save(model.state_dict(),save_name_4)

        if ACC_>ACC_5  and epoch>=40 and epoch < 50:
            ACC_5 = ACC_
            torch.save(model.state_dict(),save_name_5)
        
        if ACC_>ACC_6  and epoch>=50 and epoch < 60:
            ACC_6 = ACC_
            torch.save(model.state_dict(),save_name_6)

        if ACC_>ACC_7  and epoch>=60 and epoch < 70:
            ACC_7 = ACC_
            torch.save(model.state_dict(),save_name_7)
        
        if ACC_>ACC_8  and epoch>=70 and epoch < 80:
            ACC_8 = ACC_
            torch.save(model.state_dict(),save_name_8)

        if ACC_>ACC_9  and epoch>=80 and epoch < 90:
            ACC_9 = ACC_
            torch.save(model.state_dict(),save_name_9)
        
        if ACC_>ACC_10  and epoch>=90 and epoch < 100:
            ACC_10 = ACC_
            torch.save(model.state_dict(),save_name_10)
